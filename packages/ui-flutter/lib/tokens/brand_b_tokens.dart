...
// Sync with packages/ui-web/src/theme/tokens.ts — brandBTokens
...
class FdsBrandBTokens {
  ...
  // ── Brand colors ─────────────────────────────────────────────────────────
  static const Color colorBrandPrimary        = Color(0xFF0A8920); // Primary-500
  static const Color colorBrandPrimaryHover   = Color(0xFF07751B); // Primary-600
  static const Color colorBrandPrimaryPressed = Color(0xFF046017); // Primary-700
  static const Color colorBrandPrimarySubtle  = Color(0xFFE5F8E3); // Primary-100
  ...
  static const Color colorBrandAccent       = Color(0xFF39AD3E); // Primary-400
  static const Color colorBrandAccentSubtle = Color(0xFFE5F8E3); // Primary-100
  static const Color colorBrandOnAccent     = Color(0xFFFFFFFF);
  ...
  static const Color colorSurfaceEmphasis = Color(0xFFE5F8E3); // Primary-100
  ...
  static const Color colorTextLink      = Color(0xFF0A8920); // Primary-500
  ...
  static const Color colorBorderFocus   = Color(0xFF0A8920); // Primary-500
